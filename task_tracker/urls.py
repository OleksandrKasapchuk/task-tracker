...
urlpatterns = [
	...
	path('dashboards/<int:dashboard_pk>/delete/', task_views.DashboardDeleteView.as_view(), name='dashboard-delete'),
	path('dashboards/<int:dashboard_pk>/edit/', task_views.DashboardUpdateView.as_view(), name='dashboard-edit'),
